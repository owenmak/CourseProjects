...
Table* modify_dbl_table(Table* tbl, double* temp, int type);

Table* modify_str_table(Table* tbl, char** temp, int type);

void set_table_column(Table* tbl, char* col);

char* get_table_column(Table*);

void free_table_column(Table*);
