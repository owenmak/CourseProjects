...
Table** int_mapping(Table *traintbl, Table *validatetbl, int isPrint, int *uniqueClass) {
	int *int_class;
	int class_count = 0;
...
Table** string_mapping(Table *traintbl, Table *validatetbl, int isPrint, int *uniqueClass) { // do string mapping. return a table array tbl[0] for train, tbl[1] for validate.
	char **string_class;
	int class_count = 0;
	int column_count1 = tbl_column_count(traintbl);
	int column_count2 = tbl_column_count(validatetbl);
