//* TA changes for grading: no change at all 
...
class BMDriver extends TestDriver implements GlobalConst {
  ...
  protected boolean test2 () {
    ...
    System.out.print("  Num unpinned I" +
        SystemDefs.JavabaseBM.getNumUnpinnedBuffers() + " #" + numPages
	);
    ...
    System.out.print("  Num unpinned II " +
    ...
    if ( status == OK ) {
        ...
        if ( status == OK ) {
            System.out.print ("  - Try to free a DDoubly-pinned page\n");
            try {
